...
class Database
{
    ...
    {
        $this->stmtFile = file_get_contents(ROOTDIR . '/config/' . $fileName);
        return $this->dbHandler->exec($this->stmtFile);
    }

    // Get single row (tuple) as object
    ...
    // Get multiple tuples as an array of objects
